...
function y() {
  ...
  for (var n = e[0], o2 = [], r3 = 1, s = e.length; r3 < s; r3 += 1) o2.push(e[r3]);
...
function v(t) {
  ...
  return false ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(t, " for more information.").concat(n.length > 0 ? " Args: ".concat(n.join(", ")) : "")) : new Error(y.apply(void 0, __spreadArray([m[t]], n, false)).trim());
}
var g = 1 << 30;
...
var N = function(e) {
  ...
  for (; w.has(b); ) b++;
  var t = b++;
  if ((0 | t) < 0 || t > g) throw v(16, "".concat(t));
...
var _ = function(t, n) {
  if (true) {
    var r3 = n ? ' with the id of "'.concat(n, '"') : "", s = "The component ".concat(t).concat(r3, " has been created dynamically.\n") + "You may see this warning because you've called styled inside another component.\nTo resolve this only create new StyledComponents outside of any render method and function component.\nSee https://styled-components.com/docs/basics#define-styled-components-outside-of-the-render-method for more info.\n", i = console.error;
    try {
      var a2 = true;
      console.error = function(t2) {
        for (var n2 = [], o2 = 1; o2 < arguments.length; o2++) n2[o2 - 1] = arguments[o2];
        C.test(t2) ? (a2 = false, A.delete(s)) : i.apply(void 0, __spreadArray([t2], n2, false));
...
function oe(e, t, n) {
  if ("string" != typeof t) {
    ...
    var r3 = K(t);
    Q && (r3 = r3.concat(Q(t)));
    for (var s = X(e), i = X(t), a2 = 0; a2 < r3.length; ++a2) {
      var c2 = r3[a2];
      if (!(c2 in H || n && n[c2] || i && c2 in i || s && c2 in s)) {
        var u2 = ee(t, c2);
        try {
          Z(e, c2, u2);
        } catch (e2) {
...
function ue(e, t, n) {
  ...
  if (Array.isArray(t)) for (var o2 = 0; o2 < t.length; o2++) e[o2] = ue(e[o2], t[o2]);
  else if (ce(t)) for (var o2 in t) e[o2] = ue(e[o2], t[o2]);
  return e;
}
function le(e, t) {
...
var pe = (function() {
  ...
  return e.prototype.indexOfGroup = function(e2) {
    ...
    if (e2 >= this.groupSizes.length) {
      for (var n = this.groupSizes, o2 = n.length, r3 = o2; e2 >= r3; ) if ((r3 <<= 1) < 0) throw v(16, "".concat(e2));
    ...
    for (var n = this.groupSizes[e2], o2 = this.indexOfGroup(e2), r3 = o2 + n, s = o2; s < r3; s++) t += this.tag.getRule(s) + p;
    return t;
  }, e;
})();
...
var ye = function(e, t, n) {
  for (var o2, r3 = n.split(","), s = 0, i = r3.length; s < i; s++) (o2 = r3[s]) && e.registerName(t, o2);
};
var ve = function(e, t) {
  for (var n, o2 = (null !== (n = t.textContent) && void 0 !== n ? n : "").split(p), r3 = [], s = 0, i = o2.length; s < i; s++) {
    var a2 = o2[s].trim();
    if (a2) {
      var c2 = a2.match(de);
      if (c2) {
        var u2 = 0 | parseInt(c2[1], 10), l2 = c2[2];
        0 !== u2 && (E(l2, u2), ye(e, l2, c2[3]), e.getTag().insertRules(u2, r3)), r3.length = 0;
      } else r3.push(a2);
    }
  }
};
var ge = function(e) {
  for (var t = me(e.options.target).querySelectorAll(he), n = 0, o2 = t.length; n < o2; n++) {
    var r3 = t[n];
    r3 && r3.getAttribute(a) !== c && (ve(e, r3), r3.parentNode && r3.parentNode.removeChild(r3));
  }
};
function Se() {
...
var be = (function() {
  function e(e2) {
    this.element = we(e2), this.element.appendChild(document.createTextNode("")), this.sheet = (function(e3) {
      ...
      for (var n = null !== (t = e3.getRootNode().styleSheets) && void 0 !== t ? t : document.styleSheets, o2 = 0, r3 = n.length; o2 < r3; o2++) {
        var s = n[o2];
...
var _e = (function() {
  function e(e2, n, o2) {
    void 0 === e2 && (e2 = I), void 0 === n && (n = {});
    var r3 = this;
    this.options = __assign(__assign({}, Ae), e2), this.gs = n, this.names = new Map(o2), this.server = !!e2.isServer, !this.server && h && Ce && (Ce = false, ge(this)), le(this, function() {
      return (function(e3) {
  ...
  return e.registerId = function(e2) {
    ...
    void 0 === o2 && (o2 = true);
    var r3 = new e(__assign(__assign({}, this.options), n), this.gs, o2 && this.names || void 0);
    ...
    return this.tag || (this.tag = (e2 = (function(e3) {
      ...
      return e3.isServer ? new Ee(n) : t ? new be(n) : new Ne(n);
    })(this.options), new pe(e2)));
    var e2;
  }, e.prototype.hasNameForId = function(e2, t) {
    var n, o2;
    return null !== (o2 = null === (n = this.names.get(e2)) || void 0 === n ? void 0 : n.has(t)) && void 0 !== o2 && o2;
  }, e.prototype.registerName = function(e2, t) {
    N(e2);
    var n = this.names.get(e2);
    n ? n.add(t) : this.names.set(e2, /* @__PURE__ */ new Set([t]));
  }, e.prototype.insertRules = function(e2, t, n) {
    this.registerName(e2, t), this.getTag().insertRules(N(e2), n);
  }, e.prototype.clearNames = function(e2) {
    this.names.has(e2) && this.names.get(e2).clear();
  }, e.prototype.clearRules = function(e2) {
    this.getTag().clearGroup(N(e2)), this.clearNames(e2);
...
function De(e) {
  ...
  for (var t = e.length, n = 0, o2 = 0, r3 = false, s = 0; s < t; s++) {
    var i = e.charCodeAt(s);
    if (0 !== o2 || r3 || i !== Ie || e.charCodeAt(s + 1) !== Oe) if (r3) i === Oe && e.charCodeAt(s + 1) === Ie && (r3 = false, s++);
...
function Te(e) {
  var t, n, o2, r3 = void 0 === e ? I : e, i = r3.options, a2 = void 0 === i ? I : i, c2 = r3.plugins, u2 = void 0 === c2 ? P : c2, l2 = function(e2, o3, r4) {
    return r4.startsWith(n) && r4.endsWith(n) && r4.replaceAll(n, "").length > 0 ? ".".concat(t) : e2;
  }, p2 = u2.slice();
  p2.push(function(e2) {
    e2.type === RULESET && e2.value.includes("&") && (o2 || (o2 = new RegExp("\\".concat(n, "\\b"), "g")), e2.props[0] = e2.props[0].replace(Pe, n).replace(o2, l2));
  }), a2.prefix && p2.push(prefixer), p2.push(stringify);
  var h2 = [], d2 = middleware(p2.concat(rulesheet(function(e2) {
    return h2.push(e2);
  }))), f2 = function(e2, r4, i2, c3) {
    void 0 === r4 && (r4 = ""), void 0 === i2 && (i2 = ""), void 0 === c3 && (c3 = "&"), t = c3, n = r4, o2 = void 0;
    var u3 = (function(e3) {
      if (!De(e3)) return e3;
      for (var t2 = e3.length, n2 = "", o3 = 0, r5 = 0, s = 0, i3 = false, a3 = 0; a3 < t2; a3++) {
        var c4 = e3.charCodeAt(a3);
        if (0 !== s || i3 || c4 !== Ie || e3.charCodeAt(a3 + 1) !== Oe) if (i3) c4 === Oe && e3.charCodeAt(a3 + 1) === Ie && (i3 = false, a3++);
          ...
          if (0 === s) if (123 === c4) r5++;
            ...
            if (--r5 < 0) {
              ...
              u4 < t2 && 59 === e3.charCodeAt(u4) && u4++, r5 = 0, a3 = u4 - 1, o3 = u4;
              continue;
            }
            0 === r5 && (n2 += e3.substring(o3, a3 + 1), o3 = a3 + 1);
          } else 59 === c4 && 0 === r5 && (n2 += e3.substring(o3, a3 + 1), o3 = a3 + 1);
      ...
      for (var t2 = e3.length, n2 = [], o3 = 0, r5 = 0, s = 0, i3 = 0; r5 < t2; ) {
        var a3 = e3.charCodeAt(r5);
        if (34 !== a3 && 39 !== a3 || 0 !== r5 && 92 === e3.charCodeAt(r5 - 1)) if (0 === s) if (a3 === Ie && r5 + 1 < t2 && e3.charCodeAt(r5 + 1) === Oe) {
          for (r5 += 2; r5 + 1 < t2 && (e3.charCodeAt(r5) !== Oe || e3.charCodeAt(r5 + 1) !== Ie); ) r5++;
          r5 += 2;
        } else if (40 === a3 && r5 >= 3 && 108 == (32 | e3.charCodeAt(r5 - 1)) && 114 == (32 | e3.charCodeAt(r5 - 2)) && 117 == (32 | e3.charCodeAt(r5 - 3))) i3 = 1, r5++;
        else if (i3 > 0) 41 === a3 ? i3-- : 40 === a3 && i3++, r5++;
        else if (a3 === Oe && r5 + 1 < t2 && e3.charCodeAt(r5 + 1) === Ie) r5 > o3 && n2.push(e3.substring(o3, r5)), o3 = r5 += 2;
        else if (a3 === Ie && r5 + 1 < t2 && e3.charCodeAt(r5 + 1) === Ie) {
          for (r5 > o3 && n2.push(e3.substring(o3, r5)); r5 < t2 && 10 !== e3.charCodeAt(r5); ) r5++;
          o3 = r5;
        } else r5++;
        else r5++;
        else 0 === s ? s = a3 : s === a3 && (s = 0), r5++;
      }
      return 0 === o3 ? e3 : (o3 < t2 && n2.push(e3.substring(o3)), n2.join(""));
    })(e2)), l3 = compile(i2 || r4 ? "".concat(i2, " ").concat(r4, " { ").concat(u3, " }") : u3);
    return a2.namespace && (l3 = Re(l3, a2.namespace)), h2 = [], serialize(l3, d2), h2;
  };
  return f2.hash = u2.length ? u2.reduce(function(e2, t2) {
    return t2.name || v(15), F(e2, t2.name);
  }, 5381).toString() : "", f2;
}
var xe = new _e();
var je = Te();
var ke = import_react.default.createContext({ shouldForwardProp: void 0, styleSheet: xe, stylis: je });
var Me = ke.Consumer;
var Ve = import_react.default.createContext(void 0);
function Fe() {
  return import_react.default.useContext(ke);
}
function Ge(e) {
  if (!import_react.default.useMemo) return e.children;
  var t = Fe().styleSheet, n = import_react.default.useMemo(function() {
    var n2 = t;
  ...
  }, [e.disableCSSOMInjection, e.sheet, e.target, t]), r3 = import_react.default.useMemo(function() {
    return Te({ options: { namespace: e.namespace, prefix: e.enableVendorPrefixes }, plugins: e.stylisPlugins });
  }, [e.enableVendorPrefixes, e.namespace, e.stylisPlugins]), s = import_react.default.useMemo(function() {
    return { shouldForwardProp: e.shouldForwardProp, styleSheet: n, stylis: r3 };
  }, [e.shouldForwardProp, n, r3]);
  return import_react.default.createElement(ke.Provider, { value: s }, import_react.default.createElement(Ve.Provider, { value: r3 }, e.children));
}
var Le = (function() {
  function e(e2, t) {
    var n = this;
    ...
    }, this.name = e2, this.id = "sc-keyframes-".concat(e2), this.rules = t, le(this, function() {
      throw v(12, String(n.name));
    });
  }
  return e.prototype.getName = function(e2) {
    return void 0 === e2 && (e2 = je), this.name + e2.hash;
  }, e;
})();
function Be(e, t) {
...
var We = function(t) {
  ...
  for (var o2 in t) {
    var r3 = t[o2];
    t.hasOwnProperty(o2) && !Ye(r3) && (Array.isArray(r3) && r3.isCss || re(r3) ? n.push("".concat($e(o2), ":"), r3, ";") : ce(r3) ? n.push.apply(n, __spreadArray(__spreadArray(["".concat(o2, " {")], We(r3), false), ["}"], false)) : n.push("".concat($e(o2), ": ").concat(Be(o2, r3), ";")));
  }
  return n;
};
function qe(e, t, n, o2, r3) {
  if (void 0 === r3 && (r3 = []), "string" == typeof e) return e && r3.push(e), r3;
  if (Ye(e)) return r3;
  if (se(e)) return r3.push(".".concat(e.styledComponentId)), r3;
  if (re(e)) {
    if (!re(i = e) || i.prototype && i.prototype.isReactComponent || !t) return r3.push(e), r3;
    var s = e(t);
    return "object" != typeof s || Array.isArray(s) || s instanceof Le || ce(s) || null === s || console.error("".concat(B(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), qe(s, t, n, o2, r3);
  }
  var i;
  if (e instanceof Le) return n ? (e.inject(n, o2), r3.push(e.getName(o2))) : r3.push(e), r3;
  if (ce(e)) {
    for (var a2 = We(e), c2 = 0; c2 < a2.length; c2++) r3.push(a2[c2]);
    return r3;
  }
  if (!Array.isArray(e)) return r3.push(e.toString()), r3;
  for (c2 = 0; c2 < e.length; c2++) qe(e[c2], t, n, o2, r3);
  return r3;
}
function He(e) {
...
var Je = (function() {
  function e(e2, t, n) {
    this.rules = e2, this.staticRulesId = "", this.isStatic = false, this.componentId = t, this.baseHash = F(Ue, t), this.baseStyle = n, _e.registerId(t);
  }
  return e.prototype.generateAndInjectStyles = function(e2, t, n) {
    ...
    if (this.isStatic && !n.hash) if (this.staticRulesId && t.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      var r3 = ae(qe(this.rules, e2, t, n)), s = M(F(this.baseHash, r3) >>> 0);
      ...
      for (var a2 = F(this.baseHash, n.hash), c2 = "", u2 = 0; u2 < this.rules.length; u2++) {
        var l2 = this.rules[u2];
        if ("string" == typeof l2) c2 += l2, a2 = F(a2, l2);
        else if (l2) {
          var p2 = ae(qe(l2, e2, t, n));
          a2 = F(F(a2, String(u2)), p2), c2 += p2;
        }
      }
      if (c2) {
        var h2 = M(a2 >>> 0);
        if (!t.hasNameForId(this.componentId, h2)) {
          var d2 = n(c2, ".".concat(h2), void 0, this.componentId);
          t.insertRules(this.componentId, h2, d2);
        }
        o2 = ie(o2, h2);
      }
    }
    return { className: o2, css: "undefined" == typeof window ? t.getTag().getGroup(N(this.componentId)) : "" };
  }, e;
})();
...
function nt(e, s, i) {
  var a2 = se(e), c2 = e, u2 = !z(e), p2 = s.attrs, h2 = void 0 === p2 ? P : p2, d2 = s.componentId, f2 = void 0 === d2 ? (function(e2, t) {
    var n = "string" != typeof e2 ? "sc" : x(e2);
    et[n] = (et[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(L(l + n + et[n]));
    return t ? "".concat(t, "-").concat(o2) : o2;
  })(s.displayName, s.parentComponentId) : d2, m2 = s.displayName, y2 = void 0 === m2 ? (function(e2) {
    return z(e2) ? "styled.".concat(e2) : "Styled(".concat(B(e2), ")");
  })(e) : m2, v2 = s.displayName && s.componentId ? "".concat(x(s.displayName), "-").concat(s.componentId) : s.componentId || f2, g2 = a2 && c2.attrs ? c2.attrs.concat(h2).filter(Boolean) : h2, S2 = s.shouldForwardProp;
  if (a2 && c2.shouldForwardProp) {
    var w2 = c2.shouldForwardProp;
    if (s.shouldForwardProp) {
      var b2 = s.shouldForwardProp;
      S2 = function(e2, t) {
        return w2(e2, t) && b2(e2, t);
      };
    } else S2 = w2;
  }
  var N2 = new Je(i, v2, a2 ? c2.componentStyle : void 0);
  function E2(e2, s2) {
    return (function(e3, s3, i2) {
      var a3 = e3.attrs, c3 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, p3 = e3.styledComponentId, h3 = e3.target, d3 = import_react.default.useContext(Xe), f3 = Fe(), m3 = e3.shouldForwardProp || f3.shouldForwardProp;
      import_react.default.useDebugValue && import_react.default.useDebugValue(p3);
      var y3 = O(s3, d3, u3) || I, v3 = (function(e4, n, o2) {
        for (var r3, s4 = __assign(__assign({}, n), { className: void 0, theme: o2 }), i3 = 0; i3 < e4.length; i3 += 1) {
          var a4 = re(r3 = e4[i3]) ? r3(s4) : r3;
          for (var c4 in a4) "className" === c4 ? s4.className = ie(s4.className, a4[c4]) : "style" === c4 ? s4.style = __assign(__assign({}, s4.style), a4[c4]) : s4[c4] = a4[c4];
        }
        return "className" in n && "string" == typeof n.className && (s4.className = ie(s4.className, n.className)), s4;
      })(a3, s3, y3), g3 = v3.as || h3, S3 = {};
      for (var w3 in v3) void 0 === v3[w3] || "$" === w3[0] || "as" === w3 || "theme" === w3 && v3.theme === y3 || ("forwardedAs" === w3 ? S3.as = v3.forwardedAs : m3 && !m3(w3, g3) || (S3[w3] = v3[w3], m3 || false || isPropValid(w3) || tt.has(w3) || !D.has(g3) || (tt.add(w3), console.warn('styled-components: it looks like an unknown prop "'.concat(w3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var b3 = (function(e4, t) {
        var n = Fe(), r3 = e4.generateAndInjectStyles(t, n.styleSheet, n.stylis);
        return import_react.default.useDebugValue && import_react.default.useDebugValue(r3.className), r3;
      })(c3, v3), N3 = b3.className;
      e3.warnTooManyClasses && e3.warnTooManyClasses(N3);
      var E3 = ie(l2, p3);
      return N3 && (E3 += " " + N3), v3.className && (E3 += " " + v3.className), S3[z(g3) && !D.has(g3) ? "class" : "className"] = E3, i2 && (S3.ref = i2), (0, import_react.createElement)(g3, S3);
    })(C2, e2, s2);
  }
  E2.displayName = y2;
  var C2 = import_react.default.forwardRef(E2);
  return C2.attrs = g2, C2.componentStyle = N2, C2.displayName = y2, C2.shouldForwardProp = S2, C2.foldedComponentIds = a2 ? ie(c2.foldedComponentIds, c2.styledComponentId) : "", C2.styledComponentId = v2, C2.target = a2 ? c2.target : e, Object.defineProperty(C2, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(e2) {
    this._foldedDefaultProps = a2 ? (function(e3) {
      for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
      for (var o2 = 0, r3 = t; o2 < r3.length; o2++) ue(e3, r3[o2], true);
      return e3;
    })({}, c2.defaultProps, e2) : e2;
  } }), _(y2, v2), C2.warnTooManyClasses = /* @__PURE__ */ (function(e2, t) {
    var n = {}, o2 = false;
    return function(r3) {
  ...
  })(y2, v2), le(C2, function() {
    return ".".concat(C2.styledComponentId);
  }), u2 && oe(C2, e, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), C2;
}
function ot(e, t) {
...
function st(t) {
  for (var n = [], o2 = 1; o2 < arguments.length; o2++) n[o2 - 1] = arguments[o2];
  if (re(t) || ce(t)) return rt(qe(ot(P, __spreadArray([t], n, true))));
  var r3 = t;
  return 0 === n.length && 1 === r3.length && "string" == typeof r3[0] ? qe(r3) : rt(qe(ot(r3, n)));
}
function it(n, o2, r3) {
  if (void 0 === r3 && (r3 = I), !o2) throw v(1, o2);
  var s = function(t) {
    for (var s2 = [], i = 1; i < arguments.length; i++) s2[i - 1] = arguments[i];
    return n(o2, r3, st.apply(void 0, __spreadArray([t], s2, false)));
  };
  return s.attrs = function(e) {
    return it(n, o2, __assign(__assign({}, r3), { attrs: Array.prototype.concat(r3.attrs, e).filter(Boolean) }));
  }, s.withConfig = function(e) {
    return it(n, o2, __assign(__assign({}, r3), e));
  }, s;
}
var at = function(e) {
  return it(nt, e);
...
var ut = (function() {
  function e(e2, t) {
    this.rules = e2, this.componentId = t, this.isStatic = He(e2), _e.registerId(this.componentId + 1);
  }
  return e.prototype.createStyles = function(e2, t, n, o2) {
    var r3 = o2(ae(qe(this.rules, t, n, o2)), ""), s = this.componentId + e2;
    ...
    e2 > 2 && _e.registerId(this.componentId + e2);
    var r3 = this.componentId + e2;
    this.isStatic ? n.hasNameForId(r3, r3) || this.createStyles(e2, t, n, o2) : (this.removeStyles(e2, n), this.createStyles(e2, t, n, o2));
  }, e;
})();
function lt(n) {
  for (var r3 = [], s = 1; s < arguments.length; s++) r3[s - 1] = arguments[s];
  var i = st.apply(void 0, __spreadArray([n], r3, false)), a2 = "sc-global-".concat(L(JSON.stringify(i))), c2 = new ut(i, a2);
  _(a2);
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e) {
    var t = Fe(), n2 = import_react.default.useContext(Xe), r4 = u2.get(t.styleSheet);
    return void 0 === r4 && (r4 = t.styleSheet.allocateGSInstance(a2), u2.set(t.styleSheet, r4)), import_react.default.Children.count(e.children) && console.warn("The global style component ".concat(a2, " was given child JSX. createGlobalStyle does not render children.")), i.some(function(e2) {
      return "string" == typeof e2 && -1 !== e2.indexOf("@import");
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), ("undefined" == typeof window || !t.styleSheet.server) && p2(r4, e, t.styleSheet, n2, t.stylis), import_react.default.useLayoutEffect(function() {
      return t.styleSheet.server || p2(r4, e, t.styleSheet, n2, t.stylis), function() {
        var e2;
        c2.removeStyles(r4, t.styleSheet), e2 = t.styleSheet.options.target, "undefined" != typeof document && (null != e2 ? e2 : document).querySelectorAll('style[data-styled-global="'.concat(a2, '"]')).forEach(function(e3) {
          return e3.remove();
        });
      };
    }, [r4, e, t.styleSheet, n2, t.stylis]), null;
  };
  function p2(e, n2, o2, r4, s2) {
    if (c2.isStatic) c2.renderStyles(e, f, o2, s2);
    else {
      var i2 = __assign(__assign({}, n2), { theme: O(n2, r4, l2.defaultProps) });
      c2.renderStyles(e, i2, o2, s2);
    }
  }
...
function pt(t) {
  ...
  var r3 = ae(st.apply(void 0, __spreadArray([t], n, false))), s = L(r3);
  return new Le(s, r3);
}
var dt = (function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!t) return "";
      var n = Se(), o2 = ae([n && 'nonce="'.concat(n, '"'), "".concat(a, '="true"'), "".concat(u, '="').concat(l, '"')].filter(Boolean), " ");
      return "<style ".concat(o2, ">").concat(t, "</style>");
    }, this.getStyleTags = function() {
      if (e2.sealed) throw v(2);
...
function styled(tag, options) {
  let stylesFactory;
  if (options) {
    stylesFactory = ct(tag).withConfig({
      displayName: options.label,
      shouldForwardProp: options.shouldForwardProp
    });
  } else {
    stylesFactory = ct(tag);
  }
  if (true) {
    const fn = (...styles) => {
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React2.useContext(Xe);
...
function createBox(options = {}) {
  ...
  const Box2 = React3.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime.jsx)(BoxRoot, {
      as: component,
      ref,
...
function hslToRgb(color2) {
  ...
  const f2 = (n, k2 = (n + h2 / 30) % 12) => l2 - a2 * Math.max(Math.min(k2 - 3, 9 - k2, 1), -1);
  let type = "rgb";
...
function RtlProvider({
  ...
  return (0, import_jsx_runtime2.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
function createGrid(options = {}) {
  ...
  const Grid2 = React7.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime3.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      ...
      children: React7.Children.map(children, (child) => {
        if (React7.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
  ...
  true ? Grid2.propTypes = {
    ...
    offset: import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.number, import_prop_types6.default.arrayOf(import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.number])), import_prop_types6.default.object]),
    ...
    size: import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.bool, import_prop_types6.default.number, import_prop_types6.default.arrayOf(import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.bool, import_prop_types6.default.number])), import_prop_types6.default.object]),
...
true ? Grid.propTypes = {
   ...
   */
  offset: import_prop_types7.default.oneOfType([import_prop_types7.default.string, import_prop_types7.default.number, import_prop_types7.default.arrayOf(import_prop_types7.default.oneOfType([import_prop_types7.default.string, import_prop_types7.default.number])), import_prop_types7.default.object]),
  /**
   ...
   */
  size: import_prop_types7.default.oneOfType([import_prop_types7.default.string, import_prop_types7.default.bool, import_prop_types7.default.number, import_prop_types7.default.arrayOf(import_prop_types7.default.oneOfType([import_prop_types7.default.string, import_prop_types7.default.bool, import_prop_types7.default.number])), import_prop_types7.default.object]),
  /**
   ...
   * ```
   */
  unstable_level: import_prop_types7.default.number,
  /**
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime4.jsx)(GlobalStyles_default, {
    styles: globalStyles
  });
}
...
var ThemeContext = React10.createContext(null);
if (true) {
...
function useLayerOrder(theme) {
  ...
  return (0, import_jsx_runtime7.jsx)(GlobalStyles_default2, {
    styles: layerOrder
  });
}
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime8.jsx)(Xe.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime8.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime8.jsxs)(DefaultPropsProvider_default, {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React16.Fragment, {
      children: [(0, import_jsx_runtime10.jsx)(ThemeProvider_default2, {
        themeId: scopedTheme ? themeId : void 0,
        theme: memoTheme,
        children
      }), shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsx)(GlobalStyles_default, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    forceThemeRerender: import_prop_types13.default.bool,
    /**
     ...
     */
    noSsr: import_prop_types13.default.bool,
    /**
     * The storage manager to be used for storing the mode and color scheme
     * @default using `window.localStorage`
     */
    storageManager: import_prop_types13.default.func,
    /**
...
function joinChildren(children, separator) {
  const childrenArray = React18.Children.toArray(children).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React18.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React18.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
//# sourceMappingURL=chunk-BYYBCFNB.js.map
