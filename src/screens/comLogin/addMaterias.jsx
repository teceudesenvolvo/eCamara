...
class AddProducts extends Component {
    ...
    handleGeneratePDF = () => {
        ...
        const docContent = [
            ...
            textoMateria && { text: textoMateria, style: 'textoLei' },
                            ...
                            <div className="editor-sidebar">
                                ...
                                <div className="editor-actions">
                                    {this.state.protocolGenerated ? (
                                        ...
                                        <button type="button" onClick={this.handleProtocolar} className="btn-protocolar-final">
                                ...
                                <div className="editor-text-area-wrapper">
                                    <div className="a4-page">
                                        ...
                                        <div className="a4-content">
                                            <textarea name="textoMateria" value={this.state.textoMateria} onChange={this.handleInputChange} className="main-text-editor-a4" placeholder="Digite o texto da matéria aqui..." />
                                        </div>
